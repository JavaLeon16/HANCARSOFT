...
import { LabelcolCellRenderComponent } from '../labelcol-cell-render/labelcol-cell-render.component';
...
export class GridCsComponent implements OnInit {
  ...
  changeVisibleColumn(columName,visible): void
  {
    this.gridColumnApi.setColumnVisible(columName,visible);
  }

  ensureIndexVisible(index: number, position: string = 'middle'): void {
